...
class AddAsset extends Component {
    ...
    render() {
        const trigger = <li href="#modal-add-asset" className="modal-trigger"><NavLink to="/" className="nav-link">Add Asset</NavLink></li>;
        ...
        return (
            <Modal id="modal-add-asset" header="Add Asset" actions={ actions } open={ this.state.open } trigger={ trigger } options={ options }>
                <form>
                    <label>Name:</label>
